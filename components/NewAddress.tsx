...
const NewAddress = () => {
 ...
 const allRegions = [
  ...
  { region: "Vietnam", code: "+84", flag: "🇻🇳", currency: "VND", priority: "high", market: "bulk" },
  { region: "India", code: "+91", flag: "🇮🇳", currency: "INR", priority: "high", market: "bulk" },
];
  ...
  return (
    <>
      <div className="px-6 md:px-16 lg:px-32 py-16 flex flex-col md:flex-row justify-between">
        <div className="w-full">
          ...
          <div className="space-y-3 max-w-sm mt-10">
            ...
            <div className="relative inline-flex w-[320px]">
              ...
              {openRegion && (
                <div
                  ref={regionRef}
                  role="menu"
                  className="w-full absolute inset-e-0 top-12 z-auto  overflow-hidden rounded border border-gray-300 bg-black  shadow-sm flex flex-col items-start"
                >
            ...
            <input
              className="px-2 py-2.5 focus:border-[#1a9376] transition border border-gray-500/30 rounded outline-none w-full text-gray-500"
              type="text"
              placeholder="Just the name of the State e.g Alabama"
              name="state"
              onChange={(e) =>
                setUserAddressDetails({
                  ...userAddressDetails,
        ...
        <Image src="/my_location_image.svg" alt="location" width={350} height={360}/>
      </div>
    </>
  );
};
